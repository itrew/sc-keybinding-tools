...
rm -rf "unp4k/Data/"
rm -rf "src/lib/data/extracted-files"
...
mkdir -p "src/lib/data/extracted-files"

# Copy the extracted and decoded files to a tracked folder.
cp "unp4k/Data/Libs/Config/defaultProfile.xml" "src/lib/data/extracted-files/defaultProfile.xml"
cp "unp4k/Data/Localization/english/global.ini" "src/lib/data/extracted-files/global.ini"
