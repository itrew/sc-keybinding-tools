...
mkdir -p "src/lib/data/game-files"

# Copy the extracted and decoded files to a tracked folder.
cp "unp4k/Data/Libs/Config/defaultProfile.xml" "src/lib/data/game-files/defaultProfile.xml"
cp "unp4k/Data/Localization/english/global.ini" "src/lib/data/game-files/global.ini"
